...
export const metadata: Metadata = {
  title: 'San Francisco Rent Ordinance Reference (Chapter 37) | Bowlay Law',
  description:
    'Complete plain-language reference for SF Admin Code Chapter 37 — rent control exemptions, allowable increases, all 17 just cause eviction grounds, and § 37.10B tenant harassment law. Statutory citations and carve-backs.',
  keywords: [
    'San Francisco Rent Ordinance Chapter 37',
    'SF Admin Code 37.9 just cause eviction',
    'SF rent control exemptions',
    'SF tenant harassment 37.10B',
    'San Francisco rental unit definition 37.2',
    'SF Rent Ordinance attorney',
  ],
  openGraph: {
    type: 'article',
    url: 'https://bowlaylaw.com/resources/local-ordinances/san-francisco',
    title: 'San Francisco Rent Ordinance Reference (Chapter 37) | Bowlay Law',
    description:
      'Plain-language reference for SF Admin Code Chapter 37 — rent control, all 17 just causes, and § 37.10B harassment law. Written for tenants, cited for attorneys.',
  },
};

const atGlance = [
  { label: 'Rent cap', value: '60% of CPI annually, hard cap 7% per year' },
  { label: 'Just cause required', value: 'Yes — 17 enumerated just causes' },
  ...
  { label: 'Treble damages', value: 'Not less than 3× actual damages for wrongful eviction' },
  { label: 'Established', value: '1979 — Administrative Code, Chapter 37' },
];

export default function SFOrdinanceReferencePage() {
  return (
    <>
      {/* Hero */}
      <section className="bg-white px-6 py-16 border-b border-border">
        <div className="max-w-6xl mx-auto">
          ...
          <h1 className="font-display text-4xl md:text-5xl font-bold leading-tight mb-4 text-ink">
            ...
            <br />
            <span className="text-brand-mid">Chapter 37 Reference</span>
          </h1>
          <p className="text-muted text-lg leading-relaxed mb-8 max-w-2xl">
            Plain-language reference for the SF Administrative Code, Chapter 37 — rent control
            (§ 37.3), just cause for eviction (§ 37.9), and tenant harassment (§ 37.10B). Every
            major provision, exemption, and carve-back in one place.
          </p>
          ...
          <div className="bg-brand-dark/5 border border-brand-dark/20 rounded-xl p-5 flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <div className="flex-1">
              <p className="text-ink font-medium text-sm leading-relaxed">
                I represent SF tenants in Chapter 37 cases. If your landlord violated this
                ordinance, the free case review is 15–20 minutes.
              </p>
            </div>
            <Link
              href="/contact"
      ...
      <section className="bg-cream-dark border-b border-border px-6 py-4">
        <div className="max-w-6xl mx-auto flex flex-wrap gap-3 text-sm">
          ...
          <a href="#rental-unit" className="text-brand hover:text-brand-mid underline">What Is a Rental Unit?</a>
          <a href="#rent-control" className="text-brand hover:text-brand-mid underline">Rent Control</a>
          <a href="#just-cause" className="text-brand hover:text-brand-mid underline">Just Cause</a>
          <a href="#tenant-harassment" className="text-brand hover:text-brand-mid underline">Tenant Harassment</a>
        </div>
      </section>
      ...
      <section id="rental-unit" className="bg-white px-6 py-16 border-b border-border">
        <div className="max-w-6xl mx-auto">
      ...
      <section id="rent-control" className="bg-cream-dark px-6 py-16 border-b border-border">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-10">
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row items-stretch gap-3">
                <div className="flex-1 bg-white border border-border rounded-xl p-5 text-center">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                {[
                  ...
                  {
                    citation: '§ 37.2(q)',
                    title: 'Utility Costs — Gas & Electricity',
                    body: 'Where the landlord pays gas and electricity costs for the unit, increased utility costs may be passed through to tenants as provided under § 37.2(q). The procedures and limitations are governed by Rent Board rules.',
                  },
                  {
                    citation: '§ 37.3(a)',
                    title: 'Water Bill Charges',
                    body: 'Landlords may pass through up to 50% of water bill charge increases attributable to excess use penalties or rate increases resulting from the Water System Improvement Revenue Bonds approved by voters in November 2002.',
                  },
                  {
                    citation: '§ 37.3(a)',
                    title: 'Property Tax Increases',
                    body: "Property tax increases attributable to eligible general obligation bonds of the City and County of San Francisco, the SF Unified School District, or the SF Community College District may be passed through — up to 50–100% depending on which bond measure is at issue.",
                  },
                  {
                    citation: '§ 37.2(m)',
                    title: 'RAP Loan Amortization',
                    body: "Costs associated with amortization of a Rehabilitation Assistance Program (RAP) loan — for properties in areas designated under the City's rehabilitation program — may be passed through as provided under § 37.2(m).",
                  },
                  {
                    citation: '§ 37.3(a)',
                    title: 'Lead Hazard Abatement',
                    body: 'Costs of lead hazard reduction work required under applicable health and safety laws may be petitioned as a passthrough under the Rent Board\'s capital improvement procedures, subject to Board certification and applicable caps.',
                  },
                ].map(({ citation, title, body }) => (
                  ...
                  <div className="bg-cream-dark p-5 space-y-3">
                    <div className="bg-white rounded-lg p-4 border border-border">
                      ...
                      <p className="text-muted text-sm leading-relaxed">
                        ...
                        Housing Choice Vouchers, Over-FMR, and HOPWA — the rent increase
                    ...
                    <div className="bg-white rounded-lg p-4 border border-border">
                      ...
                      <p className="text-muted text-sm leading-relaxed">
                        ...
                        increase limitations in § 37.3(a)(10)(A) do not apply.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-xl border border-border overflow-hidden">
                  ...
                  <div className="bg-cream-dark p-5">
                    <p className="text-muted text-sm leading-relaxed">
                      ...
                      member as defined in the Housing Code. Any lease provision purporting to
                      permit such an increase is void.
                    </p>
                  </div>
                </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex flex-col sm:flex-row gap-4">
                  <div className="flex-1 bg-white rounded-xl p-5 border border-border">
          ...
          {/* Rent control end CTA */}
          <div className="mt-10 border-t border-border pt-8 flex flex-col sm:flex-row items-start sm:items-center gap-4">
          ...
          <div className="space-y-10">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-xl overflow-hidden border border-border">
                  ...
                  <div className="bg-amber-50 border-t border-amber-100 p-5">
                    ...
                    <div className="space-y-3">
                      {[
                        { title: 'Subletting — one-for-one replacement (§ 37.9(a)(2)(A))', body: "A landlord cannot evict for subletting if the landlord unreasonably withheld consent to a one-for-one replacement of a departing tenant and the original tenant continues to reside in the unit. Failure to respond in writing within 14 days of the tenant's written request is deemed approval." },
                        { title: 'Addition of family members (§ 37.9(a)(2)(B))', body: "A landlord cannot evict for adding a child, parent, grandchild, grandparent, brother or sister, spouse or domestic partner — if the landlord unreasonably refused a written request and occupancy limits are not exceeded. 14-day response window applies." },
                        { title: 'General occupancy additions (§ 37.9(a)(2)(C))', body: 'Landlords cannot evict for adding occupants so long as total occupancy does not exceed: 2 persons (studio), 3 (1BR), 4 (2BR), 6 (3BR), or 8 (4BR); or the maximum permitted under state and local codes.' },
                      ].map(({ title, body }) => (
                        <div key={title} className="bg-white rounded-lg p-4 border border-amber-100">
                          <p className="text-sm font-medium text-ink mb-1">{title}</p>
                          <p className="text-amber-900 text-sm leading-relaxed">{body}</p>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="bg-amber-50 border-t border-amber-100 p-5">
                    <div className="flex items-start gap-2 text-sm text-amber-900">
                      ...
                      <span>
                        ...
                        the notice to vacate is substantially based on those acts.
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-xl overflow-hidden border border-border">
                  <div className="flex items-start gap-3 bg-cream-dark p-5">
                    ...
                    <div>
                      ...
                      <p className="text-muted text-sm leading-relaxed">Using or permitting the unit to be used for any illegal purpose.</p>
                    </div>
                  </div>
                  <div className="bg-amber-50 border-t border-amber-100 p-5">
                    <div className="space-y-2">
                ...
                {[
                  { num: 5, citation: '§ 37.9(a)(5)', title: 'Refusal to sign a renewal on materially the same terms', body: 'The tenant had an oral or written agreement that has terminated and refuses, after written request, to execute a written renewal for a further term of like duration under materially the same terms — provided such terms do not conflict with Chapter 37.' },
                  { num: 6, citation: '§ 37.9(a)(6)', title: 'Refusal of landlord access', body: 'After written notice to cease, the tenant has refused the landlord access to the unit as required by state or local law.' },
                  { num: 7, citation: '§ 37.9(a)(7)', title: 'Unapproved subtenant holding at end of term', body: 'The person holding possession at the end of the oral or written agreement is a subtenant not approved by the landlord.' },
                ].map(({ num, citation, title, body }) => (
                  <div key={num} className="flex items-start gap-3 bg-cream-dark border border-border rounded-xl p-5">
                    <span className="inline-flex w-6 h-6 rounded-full bg-red-100 text-red-600 items-center justify-center text-xs font-bold shrink-0 mt-0.5">{num}</span>
                    <div>
                      <p className="text-xs font-semibold text-brand-mid tracking-wider mb-1">{citation}</p>
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-xl overflow-hidden border border-border">
                  ...
                  <div className="bg-amber-50 border-t border-amber-100 p-5">
                    ...
                    <div className="space-y-2">
                      {[
                        'A landlord may not use OMI if a comparable unit in the building is already vacant or becomes vacant before possession is recovered.',
                        ...
                        'The landlord must file statements of occupancy with the Rent Board: within 90 days of service, every 90 days until possession is recovered, then annually for 5 years after recovery.',
                        'Only one unit per building may ever be used for owner occupancy under § 37.9(a)(8)(i).',
                ...
                <div className="flex items-start gap-3 bg-cream-dark border border-border rounded-xl p-5">
                  ...
                  <div>
                    ...
                    <p className="text-muted text-sm leading-relaxed">
                      ...
                      individual rental units from housing use, and has obtained all necessary
                      permits on or before the date the notice is given. Relocation assistance
                      required under § 37.9C.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="bg-amber-50 border-t border-amber-100 p-5">
                    <div className="space-y-2">
                      {[
                        ...
                        'Lower-income tenants displaced beyond 3 months are entitled to additional monthly relocation assistance.',
                ...
                {[
                  { num: 12, citation: '§ 37.9(a)(12) · Substantial Rehabilitation', title: 'Permanent vacancy for substantial rehabilitation (§ 37.2(s))', body: 'The landlord seeks in good faith to carry out substantial rehabilitation as defined in § 37.2(s) and has obtained all necessary permits before the notice. Relocation assistance required under § 37.9C.' },
                ].map(({ num, citation, title, body }) => (
                  <div key={num} className="flex items-start gap-3 bg-cream-dark border border-border rounded-xl p-5">
                    <span className="inline-flex w-7 h-6 rounded-full bg-amber-100 text-amber-700 items-center justify-center text-xs font-bold shrink-0 mt-0.5">{num}</span>
                    <div>
                      <p className="text-xs font-semibold text-brand-mid tracking-wider mb-1">{citation}</p>
                      <p className="font-medium text-ink text-sm mb-1.5">{title}</p>
                      <p className="text-muted text-sm leading-relaxed">{body}</p>
                  ...
                  <div className="flex items-start gap-3 bg-cream-dark p-5">
                    ...
                    <div>
                      ...
                      <p className="text-muted text-sm leading-relaxed">
                        ...
                        structure from rent or lease, in full compliance with § 37.9A.
                ...
                {[
                  { num: 14, citation: '§ 37.9(a)(14) · Lead Remediation', title: 'Temporary recovery for required lead remediation or abatement', body: 'The landlord seeks in good faith to temporarily recover the unit solely for lead remediation or abatement required by SF Health Code Articles 11 or 26. Tenant vacates only for the minimum time required. Relocation rights and financial assistance under Admin Code Chapter 72 apply.' },
                  { num: 15, citation: '§ 37.9(a)(15) · Development Agreement Demolition', title: 'Demolition pursuant to a City development agreement (Admin Code Chapter 56)', body: 'The landlord seeks in good faith to demolish or permanently remove the unit from housing use in accordance with a development agreement entered into by the City under Admin Code Chapter 56.' },
                  { num: 16, citation: '§ 37.9(a)(16) · Good Samaritan Status Expiration', title: 'Expiration of a Good Samaritan tenancy (§ 37.2(a)(1)(D))', body: "The tenant's Good Samaritan Status has expired and the landlord serves a notice of termination within 60 days after expiration." },
                ].map(({ num, citation, title, body }) => (
                  <div key={num} className="flex items-start gap-3 bg-cream-dark border border-border rounded-xl p-5">
                    <span className="inline-flex w-7 h-6 rounded-full bg-amber-100 text-amber-700 items-center justify-center text-xs font-bold shrink-0 mt-0.5">{num}</span>
                    <div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  { label: 'Actual Damages', body: 'Lost rental value of the rent-controlled unit, moving costs, emotional distress, and other consequential losses.' },
                  { label: 'Injunctive Relief', body: 'A court may order the landlord to stop the eviction, restore possession, or restore severed housing services.' },
                  { label: "Attorney's Fees & Costs", body: 'The prevailing party is entitled to reasonable attorney\'s fees and costs by court order.' },
                  { label: 'Treble Damages · Not less than 3× actual damages', body: 'Emotional distress damages are trebled only if the landlord acted in knowing violation of or in reckless disregard of § 37.9. For OMI cases, the action must be brought within 5 years.' },
                ].map(({ label, body }) => (
      ...
      {/* ── TENANT HARASSMENT ── */}
      <section id="tenant-harassment" className="bg-cream-dark px-6 py-16 border-b border-border">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-10">
                ...
                <div className="rounded-xl border border-border overflow-hidden">
                  ...
                  <div className="bg-cream-dark p-5 space-y-3">
                    {[
                      ...
                      { num: '(3)', text: 'Fail to exercise due diligence in completing repairs and maintenance once undertaken, or fail to follow appropriate industry repair, containment, or remediation protocols designed to minimize exposure to noise, dust, lead paint, mold, asbestos, or other building materials with potentially harmful health impacts.' },
                    ].map(({ num, text }) => (
                      <div key={num} className="flex items-start gap-3 text-sm text-muted">
                        <span className="text-red-400 font-bold shrink-0 mt-0.5">{num}</span>
                        <span>{text}</span>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="bg-cream-dark p-5 space-y-4">
                    <div className="flex items-start gap-3 text-sm text-muted">
                      ...
                      <div>
                        ...
                        <div className="mt-2 bg-white rounded-lg p-3 border border-border text-xs leading-snug">
                          <span className="font-medium text-ink">Example expressly covered:</span> Imposing a rent increase on a unit exempt from rent control with intent to defraud, intimidate, or coerce the tenant into vacating. Evidence of bad faith includes: (1) the increase was substantially in excess of market rates for comparable units; (2) the increase came within six months after an attempt to recover possession.
                        </div>
                      </div>
                    </div>
                    <div className="flex items-start gap-3 text-sm text-muted">
                ...
                <div className="rounded-xl border border-border overflow-hidden">
                  ...
                  <div className="bg-cream-dark p-5 space-y-3">
                    {[
                      ...
                      { num: '(14)', text: "Request information that violates a tenant's right to privacy, including but not limited to residence or citizenship status or social security number." },
                    ].map(({ num, text }) => (
                      <div key={num} className="flex items-start gap-3 text-sm text-muted">
                        <span className="text-red-400 font-bold shrink-0 mt-0.5">{num}</span>
                        <span>{text}</span>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="bg-white rounded-xl p-5 border border-border sm:col-span-2">
                ...
                {[
                  { citation: "§ 37.10B(c)(5) · Attorney's Fees & Punitive Damages", body: "A prevailing plaintiff is entitled to reasonable attorney's fees and costs. The trier of fact may also award punitive damages in a proper case as defined by Civil Code § 3294. These remedies are in addition to any other existing remedies." },
                  { citation: '§ 37.10B(c)(4) · Injunction', body: 'Any aggrieved person, the City Attorney, or any person or entity who will fairly and adequately represent the interest of a protected class may seek an injunction to stop ongoing or threatened violations.' },
                  { citation: '§ 37.10B(c)(1) · Rent Board', body: 'A violation of § 37.10B constitutes a substantial and significant decrease in services under § 37.2(g). Tenants may file a petition with the Rent Board for a reduction in rent — a separate avenue from civil litigation.' },
                  { citation: '§ 37.10B(c)(6) · Defending an Eviction', body: 'In any unlawful detainer action subject to this Chapter (other than § 37.9(b) same-unit landlord cases), if the tenant is the prevailing party, the court shall award the tenant reasonable attorney\'s fees and costs. A § 37.10B violation may also be raised as an affirmative defense in an unlawful detainer.' },
                  { citation: '§ 37.10B(c)(2)–(3) · Criminal & Civil', body: 'Violations are a misdemeanor — fine up to $1,000 or up to six months in county jail. Any person, including the City, may bring a civil enforcement action. The burden of proof is preponderance of the evidence.' },
                ].map(({ citation, body }) => (
                  <div key={citation} className="bg-white rounded-xl p-5 border border-border">
                    <p className="text-xs font-semibold text-brand-mid tracking-wider mb-2">{citation}</p>
                    <p className="text-muted text-sm leading-relaxed">{body}</p>
                  </div>
                ))}
          ...
          {/* Tenant harassment end CTA */}
          <div className="mt-10 border-t border-border pt-8 flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <p className="text-muted text-sm flex-1">
              If this happened to you — a landlord making your home unlivable, refusing repairs, entering without notice, or pressuring you to leave — you don&rsquo;t have to wait for an eviction notice to call a lawyer.
            </p>
            <Link
              href="/contact"
              className="shrink-0 bg-brand-dark text-white px-5 py-2.5 rounded-full text-sm font-semibold hover:bg-brand transition-colors"
      ...
      <section className="bg-white px-6 py-12 border-b border-border">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div>
            <p className="text-ink font-medium mb-1">Representing SF tenants under Chapter 37</p>
            <p className="text-muted text-sm">
              Contingency only — no fee unless we win.{' '}
              <Link href="/locations/san-francisco" className="text-brand underline hover:text-brand-mid">
                See the SF tenant law conversion hub →
              </Link>
            </p>
          </div>
          <Link
